...
: ${AMENT_CURRENT_PREFIX:="/media/inplu/moranqiuhao/BoeingTest/mojianhao/test/install/expand01"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/expand01/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/expand01/environment/path.sh"
