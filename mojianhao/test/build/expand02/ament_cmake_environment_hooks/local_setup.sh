...
: ${AMENT_CURRENT_PREFIX:="/media/inplu/moranqiuhao/BoeingTest/mojianhao/test/install/expand02"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/expand02/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/expand02/environment/path.sh"
