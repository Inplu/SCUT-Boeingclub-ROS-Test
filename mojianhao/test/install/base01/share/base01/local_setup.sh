...
: ${AMENT_CURRENT_PREFIX:="/media/inplu/moranqiuhao/BoeingTest/mojianhao/test/install/base01"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/base01/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/base01/environment/path.sh"
